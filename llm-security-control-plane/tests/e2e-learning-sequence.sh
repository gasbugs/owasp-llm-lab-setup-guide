...
wait_json http://127.0.0.1:18096/healthz '.ok == true'
...
wait_json http://127.0.0.1:18092/healthz '.ok == true'

curl -fsS --max-time 60 -X POST http://127.0.0.1:18092/api/scan \
...
curl -fsS --max-time 60 -X POST http://127.0.0.1:18092/api/scan-output \
  -H 'Content-Type: application/json' \
...
wait_json http://127.0.0.1:18091/healthz '.ok == true'

curl -fsS --max-time 60 -X POST http://127.0.0.1:18092/api/labs/retrieval \
  -H 'Content-Type: application/json' \
...
curl -fsS --max-time 90 -X POST http://127.0.0.1:18091/api/chat \
  -H 'Content-Type: application/json' \
...
wait_json http://127.0.0.1:18093/healthz '.ok == true'
...
wait_json http://127.0.0.1:18094/healthz '.ok == true'

curl -fsS --max-time 120 -X POST http://127.0.0.1:18094/api/chat \
