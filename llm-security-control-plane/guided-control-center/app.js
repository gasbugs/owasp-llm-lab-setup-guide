...
function renderTabs() {
  ...
  tabNames.forEach((name, index) => {
    ...
    button.type = "button";
    const implemented = index <= 3 || index === 12;
...
function setBusy(busy) {
  ["preflight", "verify", "chat-send", "h02-provision", "h02-verify", "h03-provision", "h03-verify", "h04-provision", "h04-verify", "h05-verify", "h21-verify", "h22-verify"].forEach((id) => {
