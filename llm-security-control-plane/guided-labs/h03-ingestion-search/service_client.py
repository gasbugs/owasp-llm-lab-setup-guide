"""Two bounded P03 operations; lifecycle and verifier credentials never enter here."""
import hashlib
import json
    ...
    def _invoke(self, operation, payload):
        ...
        try:
            ...
            with httpx.Client(timeout=30, follow_redirects=False, trust_env=False) as client:
                with client.stream("POST", self.origin + "/v1/p03/invoke",
            ...
            raise ServiceError("P03 search service failed") from None

    async def job_status(self):
        return self._invoke("job_status", {})

    async def retrieve(self):
        return self._invoke("retrieve", {})
