...
CloudSecurityLab Bank 챗봇 + 의도된 RBAC 우회 + 누구나 RAG 코퍼스에 문서를 주입 가능.
"""
...
SYSTEM_PROMPT_TEMPLATE = f"""너는 'CloudSecurityLab Bank 고객 서비스 AI'야.
...
_corpus: List[str] = [
    "CloudSecurityLab Bank policy 2024: VIP customers receive 0.5% interest bonus.",
    "CloudSecurityLab Bank branch hours: 09:00-16:00 weekdays only.",
]
...
scenario = Scenario(
    id="day2",
    title="CloudSecurityLab Bank 고객 서비스 (LLM02/LLM04)",
    intro="CloudSecurityLab Bank 챗봇이야. 권한 우회로 다른 고객 정보 얻기, RAG poisoning 등.",
    warning="의도적 취약 — CloudSecurityLab Bank는 교육용 가상 은행이며 실제 금융 시스템이 아님.",
