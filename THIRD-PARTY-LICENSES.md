...
| NGINX Unprivileged | `llm-security-control-plane/guided-front-proxy/` base image and runtime | BSD-2-Clause | <https://github.com/nginxinc/docker-nginx-unprivileged> |
