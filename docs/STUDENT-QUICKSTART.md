...
보안 그룹에서 실습 포트를 외부에 공개하지 않아도 SSM 포트포워딩으로 로컬 브라우저와 `curl`을 연결할 수 있습니다. 다음 명령은 수강생 노트북에서 실행하며, 상시 서비스 포트 3000·5000·8000~8002·8010~8013·8080·8501·11434와 별도 실습 프로세스 포트 18002·18012·18080·18090~18092·18200을 같은 localhost 포트로 전달합니다. 사용하지 않는 8003~8009와 8014~8079에는 listener가 없으므로 불필요한 SSM 세션을 만들지 않습니다.
