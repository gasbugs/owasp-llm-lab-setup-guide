...
- Microsoft Presidio 정책: `examples/day6/presidio/presidio_core.py`
- Microsoft Presidio API: `examples/day6/presidio/server.py`
...
8013을 사용하지만 host에서는 Microsoft Presidio 18091, NeMo 18092로 분리한다. 기존 Day 5의
8013과 충돌하지 않는다.
...
이 값들은 Analyzer 실행과 entity allowlist에 실제로 적용된다.
